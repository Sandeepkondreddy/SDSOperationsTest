...
$(document).ready(function (){
    ...
    $("#btnSubmit").click(function() {
        ...
        else
        {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://202.83.27.199/KPCTSDSTEST/api/Account/AddUserStages',
                dataType: "json",
                contentType : "application/json",
...
function GetUsers()
{
    ...
    $.ajax({
        ...
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Account/GetUsers',
        dataType: "json",
        data: '{}',
        async: false,
        success: function (result) {
...
function GetStages()
{
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json; charset=utf-8",
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Masters/GetStatus',
        dataType: "json",
        data: '{}',
        async: false,
        success: function (result) {
