...
$(document).ready(function (){
    ...
    $("#btnSubmit").click(function (){
        ...
        if(Validations())
        {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://202.83.27.199/KPCTSDSTEST/api/TallySheet/AddData',
...
function GetLocations()
{
    ...
    $.ajax({
        ...
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Location/GetLocation/' + $("#hidloctype").val(),
        dataType: "json",
        data: '{}',
        async: false,
        success: function (result) {
...
function GetCargoCondition()
{
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json; charset=utf-8",
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Masters/GetCargoCondition',
        dataType: "json",
        data: '{}',
        async: false,
        success: function (result) {
...
function GetWeatherCondition()
{
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json; charset=utf-8",
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Masters/GetWeatherCondition',
        dataType: "json",
        data: '{}',
        async: false,
        success: function (result) {
...
function GetHandledCompany()
{
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json; charset=utf-8",
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Masters/GetHandledCompany',
        dataType: "json",
        data: '{}',
        async: false,
        success: function (result) {
