...
$(document).ready(function () {
    ...
    $("#home").click(function () {
        ...
        $.ajax({
            type: "GET",
            url: "http://202.83.27.199/KPCTSDSTEST/api/Account/GetUserScreens/" + $("#hidusrid").val(),
            data: '{}',
    ...
    $("#btnSubmit").click(function (){
        ...
        else
        {
            ...
            $.ajax({
                type: 'POST',
                url: 'http://202.83.27.199/KPCTSDSTEST/api/TruckDetails/AddData',
                dataType: "json",
                data: Adddata,
                success: function (result) {
...
function GetUserStages(userid)
{
    ...
    $.ajax({
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Account/GetUserStages/' + userid,
        type: 'GET',
        data: '{}',
        dataType: 'json',
        async: false,
...
function GetTruckDetails(truckno)
{
    ...
    {
        $.ajax({
            url: 'http://202.83.27.199/KPCTSDSTEST/api/TruckDetails/GetTruckDetails/' + trkno,
            type: 'GET',
            data: '{}',
            dataType: 'json',
            async: false,
...
function GetTag_TruckDetails(tagno)
{
    ...
    {
        $.ajax({
            url: 'http://202.83.27.199/KPCTSDSTEST/api/TruckDetails/GetTagTruckDetails/' + TagNo,
            type: 'GET',
            data: '{}',
            dataType: 'json',
            async: false,
...
function Reason()
{
    ...
    $.ajax({
        ...
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Reason/GetReasons',
        dataType: "json",
        data: '{}',
        async: false,
...
function GetDeviceStatus()
{
    ...
    $.ajax({
        type: "POST",
        url: 'http://202.83.27.199/KPCTSDSTEST/api/Account/GetDeviceStatus',
        dataType: "json",
        data: Adddata,
        async: false,
        success: function (result) {
